...
export default function Footer() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center bg-[#D7E8EE]/65 items-center text-center px-4 sm:px-6 overflow-hidden">
      ...
      {/* Wrapper */}
      <div className="relative z-20 flex flex-col items-center justify-between min-h-screen py-6 sm:py-6">
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Subtext */}
          <p className="mt-3 text-[13px] sm:text-[14px] md:text-[15px] leading-[1.6] text-[#4d7a86] max-w-[520px]">
        ...
        <div className="flex flex-col sm:flex-row gap-8 sm:gap-5 md:gap-6 mt-12 sm:mt-4 w-full items-center justify-center">
          {[
            {
              text: `"MashAllah, the best Quran app I've used."`,
              author: "Ahmed K.",
            },
            {
              text: `"Beautiful design and very easy to use."`,
              author: "Fatima R.",
            },
            {
              text: `"The audio quality is amazing."`,
              author: "Ibrahim M.",
            },
          ].map((item, index) => (
            <div
              key={index}
              className="
                w-[85%] sm:w-[200px] md:w-[220px] lg:w-[240px]
                h-auto sm:h-[120px] md:h-[125px] lg:h-[130px]
                bg-white rounded-[16px] shadow-sm p-4
                flex flex-col justify-between text-left
                transition-all duration-300
                hover:scale-110 hover:bg-[#e6f5f9] hover:shadow-md
              "
            >
              <div>
              ...
              <div className="text-[12px] text-[#2f8aa3] font-semibold mt-2 sm:mt-0">
                — {item.author}
              </div>
            </div>
          ))}
